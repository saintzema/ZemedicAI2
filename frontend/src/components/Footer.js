...
const Footer = () => {
  const navigation = {
    solutions: [
      { name: 'Radiology AI', href: '#' },
      { name: 'Neurology AI', href: '#' },
      { name: 'Cardiology AI', href: '#' },
      { name: 'Oncology AI', href: '#' },
      { name: 'Pathology AI', href: '#' },
    ],
    company: [
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-2xl font-bold text-white">ZemedicAI</span>
            </div>
            <p className="text-gray-300 text-base">
              Revolutionizing medical diagnostics through AI-powered image analysis, helping healthcare professionals make faster, more accurate diagnoses.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6">
            <div className="flex space-x-6 md:order-2">
              {navigation.legal.map((item) => (
                <a key={item.name} href={item.href} className="text-sm text-gray-400 hover:text-gray-300">
                  {item.name}
                </a>
              ))}
            </div>
            <p className="text-base text-gray-400 md:order-1">
              &copy; {new Date().getFullYear()} ZemedicAI, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </div>
